...
export const login = createAsyncThunk("login", async ({ email, password }, { rejectWithValue }) => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/login`
    const config = {
        headers: {
...
export const register = createAsyncThunk("register", async ({ name, email, password, avatar }, { rejectWithValue }) => {
    ...
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/register`
    try {
...
export const sendQuery = createAsyncThunk("sendQuery", async ({ name, contactNo, softwareName, description }, { rejectWithValue }) => {
    ...
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/sendQuery`
    try {
...
export const getAllQueries = createAsyncThunk("getAllQueries", async () => {
    ...
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/admin/allEmails`
    try {
...
export const logout = createAsyncThunk("logout", async (_, { rejectWithValue }) => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/logout`
...
export const loadUser = createAsyncThunk("loadUser", async () => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/me`
    const config = {
        headers: {
...
export const updatePassword = createAsyncThunk("updatePassword", async ({ oldPassword, newPassword, confirmPassword }) => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/password/Update`
...
export const updateProfile = createAsyncThunk("updateProfile", async ({ name, email, avatar }) => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/me/Update`
...
export const getAllUsers = createAsyncThunk("getAllUsers", async () => {
    ...
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/admin/users`
    const config = { headers: { "Content-Type": "application/multipart/form-data" }, withCredentials: true };
    try {
        const response = await axios.post(url, {}, config)
...
export const deleteUser = createAsyncThunk("deleteUser", async (id,{ rejectWithValue }) => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/admin/user/delete/${id}`
    const config = { headers: { "Content-Type": "application/json" },withCredentials: true };
    try {
        const response = await axios.post(url,{},config)
        return response.data
...
export const editRoleOfUser = createAsyncThunk("editRoleOfUser", async (id,{ rejectWithValue }) => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/admin/user/update/${id}`
    const config = { headers: { "Content-Type": "application/json" },withCredentials: true };
    try {
...
export const getSingleUserAdmin = createAsyncThunk("getSingleUserAdmin", async (id,{ rejectWithValue }) => {
    let url = `https://readysoftwarebackend.metablocktechnologies.org/api/v1/admin/user/${id}`
    const config = { headers: { "Content-Type": "application/json" },withCredentials: true };
    try {
        const response = await axios.post(url,{},config)
